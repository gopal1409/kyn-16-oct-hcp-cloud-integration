...
terraform {
  ...
  backend "azurerm" {
    resource_group_name   = "gopal-storage-account" #replace it with the rg of storage account
    storage_account_name  = "terraformstoragegopal" #replace it with storage account name
